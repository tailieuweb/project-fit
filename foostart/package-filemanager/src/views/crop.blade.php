<div class="row">
  ...
  <div class="col-md-4">
    <div class="text-center">
      ...
      <button class="btn btn-primary" onclick="performCrop()">{{ trans('package-filemanager::lfm.btn-crop') }}</button>
      <button class="btn btn-primary" onclick="performCropNew()">{{ trans('package-filemanager::lfm.btn-copy-crop') }}</button>
