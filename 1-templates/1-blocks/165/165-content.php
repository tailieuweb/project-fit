    ...
    <div class="container intro">
        <div class="row">
            <div class="col-md-8">
                ...
                <div class="row maincontent headline">
                    <div class="col-md-12">
                        ...
                        <ul>
                            <li  data-aos="fade-right">Đào tạo Cử nhân Cao đẳng ngànnh;Công nghệ Thông tin,;Truyền thông và;Mạng máy tính.</li>
                            <li  data-aos="fade-right">Đào tạo hệ TCCN các ngành Tin học ứng dụng, Truyền thông đa phương tiện.</li>
                            <li  data-aos="fade-right">Trang bị kiến thức cơ bản về CNTT cho sinh viên các hệ, các khoa không chuyên.</li>
                            <li  data-aos="fade-right">Bồi dưỡng, cập nhật kiến thức CNTT cho đội ngũ cán bộ theo yêu cầu chuẩn hóa đội ngũ và nâng cao trình độ chuyên môn theo yêu cầu công tác.</li>
                        ...
                        <ul>
                            <li data-aos="fade-right">Phòng thực hành các môn ứng dụng - phần mềm.</li>
                            <li data-aos="fade-right">Phòng thực hành Đồ hoạ; Thiết kế Web.</li>
                            <li data-aos="fade-right">Phòng thực hành Lắp ráp; Cấu trúc máy tính.</li>
