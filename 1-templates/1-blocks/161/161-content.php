        ...
        <div class="programmer">
            <div class="program">
                <div class="row">
                    ...
                    <div class="col-md-5 col-sm-5 col-xs-12 major college">
                        <ul>
        ...
        <div class="programmer">
            <div class="program">
                <div class="row">
                    ...
                    <div class="col-md-5 col-sm-5 col-xs-12 major vocational">
                        <ul>
        ...
        <div class="programmer">
            <div class="program">
                <div class="row">
                    ...
                    <div class="col-md-5 col-sm-5 col-xs-12 major collegetrans">
                        <ul>
