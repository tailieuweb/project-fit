...
return [
    ...
    */
    'pages' => [
        ...
        'title_courses' => 'Danh sách học phần',
        'title_list_search_courses' => 'Danh sách học phần',
        'title-list' => 'List of companies',
        'title-list-pattern' => 'List of patterns',
        'title-list-search' => 'Search results',
        'title-list-pattern-search' => 'Search results',
        'title-edit' => 'Cập nhật lớp học',
        'title-add' => 'Thêm mới lớp học',
    ...
    */
    'descriptions' => [
        'form' => 'Crawler form',
        'course_description' => 'Giới thiệu sơ lược về lớp học, nội quy, thời gian, ...',
        'list_course' => 'Danh sách các lớp học phần đã được phân công',
        'teacher_id' => 'Teacher',
        'course_image' => 'Course_image',
        'course_start_date' => 'Ngày bắt đầu',
        'course_end_date' => 'Ngày kết thúc',
        'course_name' => 'Tên lớp học phần kèm theo thông tin giảng viên. Ví dụ: Thực tập doanh nghiệp [Tên GV]',
        ...
        'status' => 'Trạng thái của lớp học: lớp đã đủ thông tin, chưa đủ thông tin',
        ...
        'courses_form' => 'Thông tin lớp học',
        'courses_id' => 'Course ID',
        'courses_image' => 'Hình đại diện lớp học',
    ...
    */
    'labels' => [
        ...
        'description' => 'Crawler description',
        'image' => 'Crawler image',
        'files' => 'Mẫu 4 danh sách sinh viên',
    ...
    'tabs' => [
        ...
        'basic'  => 'Basic',
        'advance' => 'Advance',
        'menu_1_require' => 'Thông tin bắt buộc',
        'menu_2_other' => 'Thông tin thêm',
    ],
    ...
    */
    'actions' => [
        'add-ok' => 'Thêm lớp mới thành công',
        'add-error' => 'Thêm lớp mới thất bại',
        'edit-ok' => 'Cập nhật thông tin lớp thành công',
        'edit-error' => 'Cập nhật thông tin lớp thất bại',
        'delete-ok' => 'Xóa lớp thành công',
        'delete-error' => 'Xóa lớp thất bại',
    ],
];
