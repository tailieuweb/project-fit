...
<?php if(!empty($company) && (!$company->isEmpty()) ): ?>
    <div style="min-height: 50px;">
        <div>
            <?php if($company->total() == 1): ?>
                <?php echo trans($plang_admin.'.descriptions.counter', ['number' => 1]); ?>

            <?php else: ?>
                <?php echo trans($plang_admin.'.descriptions.counters', ['number' => $company->total()]); ?>
    ...
    <table class="table table-hover">
        ...
        <thead>
            <tr style="height: 50px;">
                ...
                <th class="hidden-xs" style='width:<?php echo e($withs[$name]); ?>'>
                    <?php echo trans($plang_admin.'.columns.company_name'); ?>
        ...
        <tbody>
            ...
            <?php $__currentLoopData = $company; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    ...
                    <!--ID-->
                    <td>
                        <a href="<?php echo URL::route('company.edit', [   'id' => $item->company_id,
                                                                        '_token' => csrf_token()
                                                                     ]); ?>">
                    ...
                    <td>
                        <!--edit-->
                        <a href="<?php echo URL::route('company.edit', [   'id' => $item->id,
                                                                    '_token' => csrf_token()
                                                                ]); ?>">
                        ...
                        <!--copy-->
                        <a href="<?php echo URL::route('company.copy',[    'cid' => $item->id,
                                                                    '_token' => csrf_token(),
                                                                ]); ?>"
                            class="margin-left-5">
                        ...
                        <!--delete-->
                        <a href="<?php echo URL::route('company.delete',[  'id' => $item->id,
                                                                    '_token' => csrf_token(),
                                                                  ]); ?>"
    ...
    <div class="paginator">
        <?php echo $company->appends($request->except(['page']) )->render($pagination_view); ?>
...
<?php /**PATH /var/www/html/internship/2-source/vendor/foostart/package-company/Views/admin/company-item.blade.php ENDPATH**/ ?>