<div class="panel panel-info">
    ...
    <div class="panel-body">
        ...
        <?php echo Form::open(['route' => 'crawler.site.list','method' => 'get']); ?>


            <!--BUTTONS-->
            <div class="form-group">
                <a href="<?php echo URL::route('crawler.site.list', ['context' => @$params['context']]); ?>" class="btn btn-default search-reset">
...
<?php /**PATH /var/www/html/internship/2-source/vendor/foostart/package-crawler/Views/admin/crawler/site/site-search.blade.php ENDPATH**/ ?>