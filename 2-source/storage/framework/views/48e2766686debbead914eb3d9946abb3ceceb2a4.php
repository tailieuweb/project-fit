<div class="panel panel-info">
    ...
    <div class="panel-body">
        ...
        <?php echo Form::open(['route' => 'company','method' => 'get']); ?>


            <!--BUTTONS-->
            <div class="form-group">
                <a href="<?php echo URL::route('company', ['context' => @$params['context']]); ?>" class="btn btn-default search-reset">
...
<?php /**PATH /var/www/html/internship/2-source/vendor/foostart/package-company/Views/admin/company-search.blade.php ENDPATH**/ ?>