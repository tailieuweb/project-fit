...
<?php if(!empty($items)): ?>
    <div style="min-height: 50px;">
        ...
        <div>
            <?php echo trans($plang_admin.'.descriptions.counter_uncompany', ['number' => $counterUnCompany]); ?>
    ...
    <div class="table-responsive">
        <div>
            <!--Export-->
            <a class='btn-form btn btn-info pull-left' href="<?php echo URL::route('course.export', [
                                                        'id' => $request->get('id'),
                                                        '_token' => csrf_token()
                                                        ]); ?>">
                Export
...
<?php /**PATH /var/www/html/internship/2-source/vendor/foostart/package-courses/Views/admin/course-view-item.blade.php ENDPATH**/ ?>