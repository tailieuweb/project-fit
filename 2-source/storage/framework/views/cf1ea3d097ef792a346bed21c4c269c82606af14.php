...
<?php if(!empty($courses) && (!$courses->isEmpty()) ): ?>
    <div style="min-height: 50px;">
        ...
        <?php echo Form::submit(trans($plang_admin.'.buttons.exportByTeacher'), array(
        ...
        <tbody>
            ...
            <?php $__currentLoopData = $courses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    ...
                    <!--ID-->
                    <td>
                        <a href="<?php echo URL::route('course.edit', [   'id' => $item->course_id,
                                                                        '_token' => csrf_token()
                                                                     ]); ?>">
                    ...
                    <td>
                        <!--edit-->
                        <a href="<?php echo URL::route('course.edit', [   'id' => $item->id,
                                                                    '_token' => csrf_token()
                                                                ]); ?>">
                        ...
                        <!--raw-->
                        <a href="<?php echo URL::route('course.raw', [ 'id' => $item->id,
                                                        '_token' => csrf_token()
                                                        ]); ?>">
                        ...
                        <!--raw-->
                        <a href="<?php echo URL::route('course.view', [ 'id' => $item->id,
                                                        '_token' => csrf_token()
                                                        ]); ?>">
                        ...
                        <!--copy-->
                        <a href="<?php echo URL::route('course.copy',[    'cid' => $item->id,
                                                                    '_token' => csrf_token(),
                                                                ]); ?>"
                            class="margin-left-5">
                        ...
                        <!--delete-->
                        <a href="<?php echo URL::route('course.delete',[  'id' => $item->id,
                                                                    '_token' => csrf_token(),
                                                                  ]); ?>"
...
<?php /**PATH /var/www/html/internship/2-source/vendor/foostart/package-courses/Views/admin/course-item.blade.php ENDPATH**/ ?>