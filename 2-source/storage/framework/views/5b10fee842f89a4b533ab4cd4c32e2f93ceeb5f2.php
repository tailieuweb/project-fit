<div class="panel panel-info">
    ...
    <div class="panel-body">
        ...
        <?php echo Form::open(['route' => 'course','method' => 'get']); ?>


            <!--BUTTONS-->
            <div class="form-group">
                <a href="<?php echo URL::route('course', ['context' => @$params['context']]); ?>" class="btn btn-default search-reset">
...
<?php /**PATH /var/www/html/internship/2-source/vendor/foostart/package-courses/Views/admin/course-search.blade.php ENDPATH**/ ?>